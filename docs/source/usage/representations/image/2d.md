...
# Custom image size
featurizer_512 = mbl.get_featurizer("rdkit_2d_image", image_size=(512, 512))
...
featurizer_large = mbl.get_featurizer("rdkit_2d_image", 
                                     image_size=(400, 400), 
                                     kekulize=False)
...
featurizer = mbl.get_featurizer("chemception_image")
...
featurizer_hires = mbl.get_featurizer("chemception_image", 
                                     image_size=160, 
                                     resolution=0.25)
...
featurizer = mbl.get_featurizer("deepscreen_image")
...
featurizer_rgb = mbl.get_featurizer("deepscreen_image", grayscale=False)
color_image = featurizer_rgb.featurize("CC(=O)OC1=CC=CC=C1C(=O)O")
print(f"Color shape: {color_image.shape}")  # (200, 200, 3)

# Custom image size
featurizer_custom = mbl.get_featurizer("deepscreen_image", 
                                      image_size=128, 
                                      grayscale=True)
...
featurizer = mbl.get_featurizer("cnn_features_resnet")
...
resnet18 = mbl.get_featurizer("cnn_features_resnet", model_name="resnet18")
resnet50 = mbl.get_featurizer("cnn_features_resnet", model_name="resnet50")
vgg16 = mbl.get_featurizer("cnn_features_resnet", model_name="vgg16")
...
featurizer_custom = mbl.get_featurizer("cnn_features_resnet",
                                      model_name="resnet18",
                                      image_size=256, 
                                      pretrained=True)
...
rdkit_img = mbl.get_featurizer("rdkit_2d_image").featurize(test_molecule)
chemception_img = mbl.get_featurizer("chemception_image").featurize(test_molecule)  
cnn_feat = mbl.get_featurizer("cnn_features_resnet").featurize(test_molecule)
