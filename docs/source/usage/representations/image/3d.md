...
featurizer = mbl.get_featurizer("deepsnap_3d")
...
featurizer_custom = mbl.get_featurizer("deepsnap_3d", 
...
axes_coverage = {}
for axis in ["x", "y", "z"]:
    axis_featurizer = mbl.get_featurizer("deepsnap_3d", axis=axis, rotation_angles=[0, 90, 180, 270])
...
featurizer = mbl.get_featurizer("voxel_grid")
...
featurizer_hires = mbl.get_featurizer("voxel_grid", 
                                     grid_size=64, 
                                     resolution=0.25)
...
featurizer_compact = mbl.get_featurizer("voxel_grid", 
                                       grid_size=24, 
                                       resolution=0.8)
...
featurizer = mbl.get_featurizer("point_cloud_3d")
...
featurizer_large = mbl.get_featurizer("point_cloud_3d", 
                                     max_atoms=200, 
...
featurizer = mbl.get_featurizer("pymol_3d_render")
...
for style in styles:
    style_featurizer = mbl.get_featurizer("pymol_3d_render", style=style)
...
featurizer_custom = mbl.get_featurizer("pymol_3d_render",
                                      image_size=(512, 512),
...
featurizer_hires = mbl.get_featurizer("pymol_3d_render",
...
featurizer = mbl.get_featurizer("surface_descriptors")
...
featurizer_dense = mbl.get_featurizer("surface_descriptors",
...
def process_3d_batch(molecules, representation="voxel_grid", batch_size=50):
    ...
    featurizer = mbl.get_featurizer(representation)
    results = []
